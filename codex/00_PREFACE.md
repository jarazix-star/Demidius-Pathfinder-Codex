...
- **Verified Campaign Fact:** confirmed by the player as true in the campaign.
- **Verified Campaign Rule:** confirmed table ruling or house rule.
- **Verified Source Option:** underlying published text was inspected.
- **Cross-referenced:** compared against Demidius's current mechanics and campaign assumptions.
- **Recommended:** current optimization recommendation.
- **GM Review:** a new edge case still requires adjudication.
- **Pending:** identified but not yet fully extracted or verified.
