...
1. Identify the enemy's protections and the real point of failure.
2. Strip magical defenses or prevent recovery.
3. Preserve the party's action economy.
4. Spend luck only when a pivotal roll would otherwise fail.
5. Enable stronger damage dealers and specialists.
6. Follow through with control, enchantment, or diplomacy.

The rapier remains a thematic backup weapon. Personal weapon damage is not the standard against which his contribution should be measured.
...
The result is a reinforcing loop: Charisma improves spellcasting, command, defense, probability resources, and the ability to endure the costs of demigodhood.

## Signature methods

### Probability control

At 17 Hit Dice, Seven-Pipped Gem provides a campaign-rules-adjusted **+10 luck bonus to any d20 roll**, or **+19 to Gambling and Sleight of Hand**. It can be declared after seeing the die but before the result is announced. Its best use is not to make a good roll spectacular; it is to turn a consequential failure into success.

### Magical defense removal

Demidius specializes in exposing protected enemies. Dispel checks, anti-recovery tools, spell-resistance penetration, and follow-up control all belong to a single sequence. The objective is to make the party's strongest action possible and reliable.
...
Demidius's progress is not free. His known Fatal Flaws require daily gambling, make disengaging from battle difficult, impair some judgments of intent, and impose paranoia after use of the Key of Daedalus. The inherited demiplane adds a Loyalty Fatal Flaw to those who receive its sleep blessing.

These are not merely roleplaying notes. They are operational constraints that require prearranged extraction authority, independent verification, controlled daily routines, corridor security, and careful consent around the demiplane.
...
- [Fatal Flaw Defense](../codex/FATAL_FLAW_DEFENSE.md)
