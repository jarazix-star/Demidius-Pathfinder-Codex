...
Use only published boons that fit Nereus's confirmed Sea, Knowledge, or
Prophecy domains, treating item-creation expertise as a Knowledge expression
and shapeshifting as a thematic expression rather than a separate domain. The
campaign-economy package is Creator / Rite of Passage / Sacred Crafting;
Sacred Crafting reduces calculated magic-item base cost, crafting time, and
final price by 10%. The fleet-command package replaces Sacred Crafting with
Rally Crew, giving gathered allies +10 feet of speed and *heroism* for 1
hour/Hit Die while benefited rolls ignore water- and weather-based penalties.
The transformation package is Discerning Mind / Rite of Passage / Adaptive
Flesh and Twisting Steel, while the combat-caster package replaces Rite of
Passage with Poisoned Mysticism. The full ranking is in
`../research/DEIFIC_OBEDIENCE_DOMAIN_RANKINGS.md`. Do not count the Animal
Lord template as an obedience boon unless the GM explicitly connects the
systems.
