...
| Mythic Spell Compendium | Legendary Games | Focused extraction | Dispel, control, utility, metamagic, infrastructure, resurrection | Full spell-by-spell Demidius relevance sweep. |
| Mythic Magic: Core Spells | Legendary Games | Partial comparison | Selected control and infrastructure spells | Complete difference audit against Spell Compendium. |
...
| Mythic Minis 51: Metamagic Feats | Legendary Games | Focused extraction | High-relevance metamagic options parsed | Finish all feats and compare with Hero's Handbook versions. |
